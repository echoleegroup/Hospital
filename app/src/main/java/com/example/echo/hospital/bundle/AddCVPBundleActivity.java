    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case 0:
                ...
                intent.setClass(AddCVPBundleActivity.this, MenuActivity.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent();
                intent.setClass(AddCVPBundleActivity.this, WashActivity.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent();
                intent.setClass(AddCVPBundleActivity.this, MdroActivity.class);
                startActivity(intent);
                break;
            case 3:
            ...
            case 4:
                ...
                intent = new Intent();
                intent.setClass(AddCVPBundleActivity.this, VAPBundleActivity.class);
                startActivity(intent);
                break;
            case 5:
                MenuActivity.bundleName = "Foley";
                intent = new Intent();
                intent.setClass(AddCVPBundleActivity.this, FoleyBundleActivity.class);
                startActivity(intent);
                break;
            case 6:
                ...
                editor.commit();
                intent = new Intent();
                intent.setClass(AddCVPBundleActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            default:
        }
