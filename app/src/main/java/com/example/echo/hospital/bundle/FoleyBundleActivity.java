...
public class FoleyBundleActivity extends AppCompatActivity {
    ...
    /*private View headerView, rowView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case 0:
                Intent intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, MenuActivity.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, WashActivity.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, MdroActivity.class);
                startActivity(intent);
                break;
            case 3:
                MenuActivity.bundleName = "CVP";
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, CVPBundleActivity.class);
                startActivity(intent);
                break;
            case 4:
                MenuActivity.bundleName = "VAP";
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, VAPBundleActivity.class);
                startActivity(intent);
                break;
            case 5:
                MenuActivity.bundleName = "Foley";
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, FoleyBundleActivity.class);
                startActivity(intent);
                break;
            case 6:
                ...
                editor.commit();
                intent = new Intent();
                intent.setClass(FoleyBundleActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            default:
        }
        ...
        protected void onPostExecute(List<String> output) {
            ...
            try {
                ...
                if (output.size() == 0) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(FoleyBundleActivity.this, R.layout.menu_adapter);
                    ...
                    ListViewAdapter adapter = new ListViewAdapter(FoleyBundleActivity.this, list);
                    listView.setAdapter(adapter);
                }
            } catch (Exception e) {
                e.printStackTrace();
